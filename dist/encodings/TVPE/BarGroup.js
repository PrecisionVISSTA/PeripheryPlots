...
function (_React$Component) {
  _inherits(BarGroup, _React$Component);
  ...
  function BarGroup() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(BarGroup)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(BarGroup, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("g", null, observations.map(function (o, i) {
