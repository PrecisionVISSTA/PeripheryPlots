...
export default function PeripheryPlotsConfigurationValidation(props) {
    return props.renderWithConfig({ ...props });  
}; 

// Default values for optional properties 
PeripheryPlotsConfigurationValidation.defaultProps = {
...
PeripheryPlotsConfigurationValidation.propTypes = {
